...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav>
        <div class="header">
            ...
            <div class="header__section">
                <div class="header__item headerButton"><a href="#">Contact</a></div>
                <div class="header__item headerButton"><a href="#">Setting</a></div>
            </div>
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <button type="button" name="button"> <a href="/dashboard">Dashboard</a> </button>

                <button type="button" name="button"> <a href="/view">Display</a> </button>

                <button type="button" name="but"> <a href="/diko">dikoplace</a> </button>
